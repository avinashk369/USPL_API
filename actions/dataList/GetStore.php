...
class GetStore extends AbstractAction {
	...
	public function execute()
	{
		...
		$brandId 	=   Yii::$app->getRequest()->getHeaders()->get('brandId');
		$regionId 	=   Yii::$app->getRequest()->getHeaders()->get('regionId');


		$model = new StoreMaster();
		$data = $model->find()
