...
class Security {
    ...
    public static function setFlagBit($flag, $position, $value){
        
        $po = $position-strlen($flag);
        $flagFinal = substr_replace($flag, $value,$po-1,1);
        return $flagFinal;
    }

	public static function getTimeNDate() {
